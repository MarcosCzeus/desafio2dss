...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO examenes (nombre, hora_inicio, hora_fin) VALUES ('$titulo_examen', '$hora_inicio', '$hora_fin')";
    $resultado = mysqli_query($db, $query);

    // Recuperar la nota del examen
    $nota_examen = $_POST['nota'];

    // Impresión de la nota del examen junto con el mensaje de éxito
    echo "Examen guardado exitosamente. Nota del examen: $nota_examen";
...
<body>
    ...
    <main class="contenedor centrar-flex">
        <form action="crear-examen.php" class="form_examen" method="post">
            ...
            <div class="form_grupo form_grupo-pregunta">
                <div class="fila">
                    ...
                    <select name="preg1_correcta" id="preg1_correcta">
                        <option value="A">Falso</option>
                        <option value="B">Verdadero</option>
                    </select>
                </div>
            ...
            <div class="form_grupo">
                <label for="hora_inicio">Hora de inicio del examen:</label>
                <input type="time" name="hora_inicio" id="hora_inicio">
            </div>

            <div class="form_grupo">
                <label for="hora_fin">Hora de fin del examen:</label>
